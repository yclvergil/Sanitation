...
public abstract class BasePageActivity extends BaseActivity {
	...
	private static final String TAG = BasePageActivity.class.getSimpleName();
		...
		public void onResponse(JSONObject jsonObject, Object requestTag) {
			...
			try {
				 ...
				 // 总记录数
					...
					//e.printStackTrace();
					Toast.makeText(this, "json解析出错："+e.getMessage(), Toast.LENGTH_SHORT).show();
				} 
		 }
