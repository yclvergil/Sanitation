 ...
 * @2015-9-1
 */
public class FileDownloadTool extends Thread {

	private static final String TAG = FileDownloadTool.class.getSimpleName();
	 ...
	 * @param threadId:线程ID
	 */
	public FileDownloadTool(URL downloadUrl, File file, int blocksize,
			int threadId) {
