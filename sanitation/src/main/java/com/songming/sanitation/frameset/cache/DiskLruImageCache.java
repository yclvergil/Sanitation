...
/**
 * 
 * 描述：android中图片硬盘缓�?Implementation of DiskLruCache by Jake Wharton modified
 * from
 * http://stackoverflow.com/questions/10185898/using-disklrucache-in-android
...
public class DiskLruImageCache implements ImageCache {
	...
	public DiskLruImageCache(Context context, String uniqueName,
			long diskCacheSize, CompressFormat compressFormat, int quality) {
		try {
