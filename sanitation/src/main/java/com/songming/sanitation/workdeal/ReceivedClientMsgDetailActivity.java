...
public class ReceivedClientMsgDetailActivity extends BaseActivity implements OnClickListener {
...
//			worktime.setText(creatdate);
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(ReceivedClientMsgDetailActivity.this,
