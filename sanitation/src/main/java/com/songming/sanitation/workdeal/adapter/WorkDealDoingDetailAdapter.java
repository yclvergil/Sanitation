 ...
 * 
 */
public class WorkDealDoingDetailAdapter extends BaseAdapter {
	...
	public WorkDealDoingDetailAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (model.getStatus() == 2) {
			...
			if (model.getExecuteName() != null) {

				holder.accomplish_proceed_name.setText("派发给："
						+ model.getExecuteName());
			} else {
				holder.accomplish_proceed_name.setText("派发给：" + "");
			}
