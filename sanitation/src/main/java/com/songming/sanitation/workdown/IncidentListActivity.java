...
import com.songming.sanitation.user.MsgSearchActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.layoutsearchimg:
                // 搜索按钮
                Intent intent = new Intent(IncidentListActivity.this, MsgSearchActivity.class);
                intent.putExtra("cate", "事件");
                startActivity(intent);
            default:
                break;
        }
