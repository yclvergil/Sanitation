...
import com.songming.sanitation.user.adapter.UpKeepItemsAdapter.ViewHolder;
 ...
 * 
 */
public class UpKeepTypeAdapter extends BaseAdapter {

	private List<TCarDto> datalist;
	private Context Context;
	private ViewHolder holder;

	public UpKeepTypeAdapter(Context Context, List<TCarDto> datalist) {
