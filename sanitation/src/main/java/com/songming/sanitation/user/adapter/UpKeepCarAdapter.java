 ...
 * 
 */
public class UpKeepCarAdapter extends BaseAdapter {
	private List<TCarDto> datalist;
	private Context Context;
	private ViewHolder holder;
	
	public UpKeepCarAdapter(Context Context, List<TCarDto> datalist) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv.setText(datalist.get(position).getCarNo().toString());
