...
public class RegisterActivity extends BaseActivity implements OnClickListener,
    ...
    protected void onCreate(Bundle arg0) {
        ...
        //初始化Bmob短信验证码
        //BmobSMS.initialize(this.getApplicationContext(), "4b5bd52bd3b6ee069a999ed45a0566dc");
        findViews();
        initViews();
    ...
    private void submitRegister() {
        ...
        try {
            ...
            /*requestHttp(jsonObject, "modifypsw", Constants.MODIFYPSW,
            Constants.SERVER_URL);*/
    ...
    private void sendMsgCode() {
        BmobSMS.requestSMSCode(this.getApplicationContext(), "11位手机号码", "sanitation",new RequestSMSCodeListener() {
    ...
    */
    ...
    private void verifyCode() {
        BmobSMS.verifySmsCode(this.getApplicationContext(),"11位手机号码", "验证码", new VerifySMSCodeListener() {
