...
public class PersonnelAdapter extends BaseAdapter {
	...
	public PersonnelAdapter(Context context, List<Integer> datalist) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.ic = (ImageView) convertView.findViewById(R.id.item_ic);
			holder.name = (TextView) convertView.findViewById(R.id.item_name);

			holder.duty = (TextView) convertView.findViewById(R.id.item_duty);

			holder.entrance = (TextView) convertView
					.findViewById(R.id.item_entrance);
